...
public class App {
    public static void main(String[] args) {
        ...
        boolean verificaRepeticao = VerifyRepeat(lista);
        System.out.println("Há elementos repetidos: " + verificaRepeticao);

        ArrayList<Integer> intersecao = intersect(lista, lista2);
        System.out.println("Interseção entre lista e lista2: " + intersecao);

        ArrayList<Integer> uniao = union(lista, lista2);
        System.out.println("União entre lista e lista2: " + uniao);
    }
    ...
    public static boolean VerifyRepeat(ArrayList<Integer> l) {
        ArrayList<Integer> elementosRepetidos = listRepeat(l);
